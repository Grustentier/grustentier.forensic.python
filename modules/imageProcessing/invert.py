...
parser = argparse.ArgumentParser(description='Code for multiple image invertation', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def invert(input_dir, export_dir):
    ...
    for filePath in filePaths: 
        ...
        cv2.imwrite(export_dir + str(filePath).replace(input_dir, ""), inverte(image))
...
if __name__ == "__main__":
    invert(arguments.input_dir, arguments.export_dir)                 
