...
parser = argparse.ArgumentParser(description='Code for multiple image denoising', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def denoise(input_dir, export_dir, threshold=10):
    ...
    for filePath in filePaths: 
        ...
        cv2.imwrite(export_dir + str(filePath).replace(input_dir, ""), getDenoisedImage(image, threshold)) 
...
if __name__ == "__main__": 
    denoise(arguments.input_dir, arguments.export_dir, arguments.threshold)    
