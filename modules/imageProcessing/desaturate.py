...
parser = argparse.ArgumentParser(description='Code for multiple image desaturation', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def desaturate(input_dir, export_dir):
    ...
    for filePath in filePaths: 
        ...
        cv2.imwrite(export_dir + str(filePath).replace(input_dir, ""), image) 
...
if __name__ == "__main__":
    desaturate(arguments.input_dir, arguments.export_dir)    
