...
parser = argparse.ArgumentParser(description='Code for multiple image cropping', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--start_x', default=0, type=int, help='The start position of x coordinate') 
parser.add_argument('--end_x', default=0, type=int, help='The end position of x coordinate')
parser.add_argument('--start_y', default=0, type=int, help='The start position of y coordinate')
parser.add_argument('--end_y', default=0, type=int, help='The end position of y coordinate')
...
def crop(input_dir, export_dir, start_x=0, end_x=0, start_y=0, end_y=0):
    ...
    hasCropDataParameters = start_x > -1 and end_x > -1 and start_y > -1 and end_y > -1
    ...
    for filePath in filePaths: 
        ...
        cv2.imwrite(export_dir + str(filePath).replace(input_dir, ""), cropped)  
...
if __name__ == "__main__": 
    crop(arguments.input_dir, arguments.export_dir, arguments.start_x, arguments.end_x, arguments.start_y, arguments.end_y)            
