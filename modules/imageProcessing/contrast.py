...
print("""
   ___                _                       _       ___          _                                                    _   
  / __|  ___   _ _   | |_   _ _   __ _   ___ | |_    | __|  _ _   | |_    __ _   _ _    __   ___   _ __    ___   _ _   | |_ 
 | (__  / _ \ | ' \  |  _| | '_| / _` | (_-< |  _|   | _|  | ' \  | ' \  / _` | | ' \  / _| / -_) | '  \  / -_) | ' \  |  _|
  \___| \___/ |_||_|  \__| |_|   \__,_| /__/  \__|   |___| |_||_| |_||_| \__,_| |_||_| \__| \___| |_|_|_| \___| |_||_|  \__|
...
parser = argparse.ArgumentParser(description='Code for multiple image contrast enhancement', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--alpha', default=1.25, type=float, help='The alpha value [1.0-3.0]')  
...
def contrast(input_dir, export_dir, alpha=1.25, beta=0):
    ...
    for filePath in filePaths: 
        ...
        cv2.imwrite(export_dir + str(filePath).replace(input_dir, ""), cv2.convertScaleAbs(image, alpha=alpha, beta=beta)) 
...
if __name__ == "__main__": 
    contrast(arguments.input_dir, arguments.export_dir, arguments.alpha, arguments.beta)
