...
parser = argparse.ArgumentParser(description='Extracting videoframes to pre processed labels from step1.py object detection process.',formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--label_database', default='', type=str, help='The root directory with included label dirs (--label_export_dir from step1.py).') 
